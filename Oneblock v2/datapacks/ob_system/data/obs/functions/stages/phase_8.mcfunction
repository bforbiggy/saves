...
summon villager 0 61 0 {Tags:["ob.trader","ob.stage_dealer"],CustomName:'{"text":"Oneblock Trader","color":"green"}',VillagerData:{profession:"minecraft:nitwit",type:"minecraft:plains"},Offers:{Recipes:[{maxUses:4,buy:{id:'minecraft:diamond',Count:16b},sell:{id:'minecraft:mycelium',Count:4b}},{maxUses:4,buy:{id:'minecraft:dirt',Count:64b},sell:{id:'minecraft:terracotta',Count:32b}},{maxUses:2,buy:{id:'minecraft:milk_bucket',Count:1b},buyB:{id:'minecraft:emerald',Count:4b},sell:{id:'minecraft:tadpole_bucket',Count:1b}},{maxUses:1,buy:{id:'minecraft:dirt',Count:1b},sell:{id:'minecraft:globe_banner_pattern',Count:1b}}]}}