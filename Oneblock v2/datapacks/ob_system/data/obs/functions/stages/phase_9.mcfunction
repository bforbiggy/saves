...
summon villager 0 61 0 {Tags:["ob.trader","ob.stage_dealer"],CustomName:'{"text":"Oneblock Trader","color":"green"}',VillagerData:{profession:"minecraft:nitwit",type:"minecraft:plains"},Offers:{Recipes:[{maxUses:4,buy:{id:'minecraft:nautilus_shell',Count:4b},buyB:{id:'minecraft:diamond',Count:8b},sell:{id:'minecraft:trident',Count:1b}},{maxUses:4,buy:{id:'minecraft:dirt',Count:32b},buyB:{id:'minecraft:redstone',Count:8b},sell:{id:'minecraft:sculk_sensor',Count:1b}},{maxUses:8,buy:{id:'minecraft:bone_meal',Count:8b},sell:{id:'minecraft:azalea',Count:1b}}]}}